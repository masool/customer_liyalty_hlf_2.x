...
const ccpPath = path.resolve(__dirname, '..', '..','..','..', 'customerloyalty-network', 'organizations', 'peerOrganizations', 'org1.example.com', 'connection-org1.json');
let ccp = JSON.parse(fs.readFileSync(ccpPath, 'utf8'));

const appAdmin = "admin"
const orgMSPID = "Org1MSP";
const gatewayDiscovery = { enabled: true, asLocalhost: true }
  ...
  */
    registerMember: async function (cardId, accountNumber, firstName, lastName, email, phoneNumber) {
        ...
        try {
            ...
            const network = await gateway2.getNetwork('customerloyalty-channel');
